package com.arena.esportes.providers.audio.player.player;
...
import com.arena.esportes.providers.audio.helpers.SoundCloudArtworkHelper;
import com.arena.esportes.providers.audio.player.media.MediaSessionWrapper;
...
public class PlaybackService extends Service implements MediaPlayer.OnErrorListener,
    ...
    private void playTrack(final TrackObject track) {
        ...
        try {
            ...
            mMediaPlayer.setDataSource(track.getLinkStream(id, secret));
            ...
            Log.e(TAG, "Could not prepare media player");
            e.printStackTrace();
        }
    }
