package com.arena.esportes.providers.audio.player.media;
...
import com.arena.esportes.providers.audio.player.remote.RemoteControlClientCompat;
import com.arena.esportes.providers.audio.player.remote.RemoteControlHelper;
...
public class MediaSessionWrapper {
     ...
     */
    static final String ACTION_TOGGLE_PLAYBACK = "com.arena.esportes.providers.soundcloud.library.media.TOGGLE_PLAYBACK";
     ...
     * Action used to catch broadcast from {@link MediaSessionReceiver}
     */
    static final String ACTION_PREVIOUS_TRACK = "com.arena.esportes.providers.soundcloud.library.media.PREVIOUS_TRACK";
