...
import com.arena.esportes.providers.videos.VideosAdapter;
import com.arena.esportes.providers.videos.api.VideoProvider;
import com.arena.esportes.providers.videos.api.VideosCallback;
...
public class VideosFragment extends Fragment implements InfiniteRecyclerViewAdapter.LoadMoreListener, VideosCallback {
        ...
        OnItemClickListener listener = (new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (videoApiClient.isYoutubeLive() || DIRECT_PLAY) {
                    YoutubeClient.playVideo(video, getPassedData()[2], mAct);
                } else {
    ...
    private void refreshItems(){
        ...
        if (videoApiClient instanceof YoutubeClient && (
