package com.arena.esportes.providers.woocommerce.model.products;
...
public class Product implements Serializable {
    ...
    @Expose
    private List<Long> relatedIds = new ArrayList<Long>();
    @SerializedName("upsell_ids")
    @Expose
    private List<Long> upsellIds = new ArrayList<Long>();
    @SerializedName("cross_sell_ids")
    @Expose
    private List<Long> crossSellIds = new ArrayList<Long>();
     ...
     * The upsell_ids
     */
    public void setUpsellIds(List<Long> upsellIds) {
     ...
     * The crossSellIds
     */
    public List<Long> getCrossSellIds() {
        return crossSellIds;
    }
     ...
     * The cross_sell_ids
     */
    public void setCrossSellIds(List<Long> crossSellIds) {
