...
public class AudioPlayerActivity extends AppCompatActivity implements MediaController.MediaPlayerControl {
    ...
    private com.arena.esportes.attachmentviewer.MusicService MusicService;
    ...
    protected void onResume() {
        super.onResume();
        //bind to service
        MusicServiceIntent = new Intent(this, com.arena.esportes.attachmentviewer.MusicService.class);
    ...
    private final class MusicServiceServiceConnection implements ServiceConnection {
        public void onServiceConnected(ComponentName className, IBinder baBinder) {
            ...
            MusicService = ((com.arena.esportes.attachmentviewer.MusicService.MusicServiceBinder) baBinder).getService();
